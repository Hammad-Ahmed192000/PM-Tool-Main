        ...
        @include('template.loginBar')
            <div class="page-name-heading wrap">
                ...
                <div class="page-name-heading-btns">
                    <div class="page-name-heading-black-box">
                        ...
                        <a href="{{route('CompaniesAdd')}}">Add New Company</a>
                    </div>
                </div>
            </div>
            <div class="right-side-content-inner ">
                <div class="right-side-content-inner-search">
                    ...
                    <input type="text" placeholder="Search Companies By Name">
                ...
                <div class="table-wrapper">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                {{$item->address}}
                                <!-- Unit 6 Centrepoint , Liosban Industrial Estate -->
                            </td>
                            <td>
                                {{$item->phone}}
                                <!-- +1(123) 0000-0000 -->
                            ...
                            <td>
                            @php
                                $type = DB::table('roles')->where('id', $item->type)->first();
                                @endphp
                                {{$type->role}}
                                <!-- Customer -->
                            </td>
